...
scoreboard players operation %mst_temp_byte reg *= %%65536 reg

scoreboard players operation %mst_temp_word reg %= %%65536 reg
...
scoreboard players add %param0%0 reg 2
scoreboard players remove %mst_length reg 2