...
execute if score %mst_bytes_left reg matches 1 run function intrinsic:memset/head_1_byte
execute if score %mst_bytes_left reg matches 2 run function intrinsic:memset/head_2_byte
execute if score %mst_bytes_left reg matches 3 run function intrinsic:memset/head_3_byte
...
execute if score %mst_length reg matches 1 run function intrinsic:memset/tail_1_byte
execute if score %mst_length reg matches 2 run function intrinsic:memset/tail_2_byte 
execute if score %mst_length reg matches 3 run function intrinsic:memset/tail_3_byte